// Default system prompt embedded as template literal string. Import anywhere you need the prompt.

export const DEFAULT_SYSTEM_PROMPT = `# AudioMid: Your AI Coding Partner & Research Assistant
